...
const EQUIPES = {
  ...
  /* Leonardo virou supervisor (antes era técnico da equipe do Milton).
     Equipe própria, ainda sem técnicos alocados. */
  "LEONARDO MAGNO PEREIRA DA SILVA MIRANDA": [],
  "MILTON ANTONIO DA MOTA COSTA": [
    "ADRIAN JUNIOR DA CUNHA ESTEVAO","ALEXSANDER SILVA OLIVEIRA","ARTHUR EMANUEL ALMEIDA RAMOS",
    "VENICIO RODRIGUES DOS SANTOS",
